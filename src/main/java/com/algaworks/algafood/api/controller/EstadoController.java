...
//		Optional<Estado> estado = estadoRepository.findById(id); // o findby id não retona uma estado e sim um
//		// optinal, que é uma clase do java para evitar o
//		// null pointer. Com o optional, ele pode ou nõ ter
//		// a classe buscada
//
//		if (estado.isPresent()) {
//			return ResponseEntity.ok(estado.get()); // uso o get aqui por agora ela não é uma estado e sim um
//// "optional", então uso o get para pegar a estado de dentro do
//// optional
//		}
//		return ResponseEntity.notFound().build();
//	}
